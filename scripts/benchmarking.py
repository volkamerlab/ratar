...
def get_similarity_pairs(benchmarkset):
    ...
    if benchmarkset == benchmarksets[0]:
        ...
        encoded_benchmarkset_path = '/home/dominique/Documents/projects/ratar-data/results/benchmarking/' \
                                    'fuzcav/sim_dis_pairs/encoding/%s_site/ratar_encoding.p'

        similarity = {'sim_pairs': calculate_similarity_pairs(sim_pairs, encoded_benchmarkset_path),
                      'dis_pairs': calculate_similarity_pairs(dis_pairs, encoded_benchmarkset_path)}

        # Save to file
        similarity_path = '/home/dominique/Documents/projects/ratar-data/results/benchmarking/' \
        ...
        raise ValueError(f'Selected benchmarking dataset unknown. Please choose from: {", ".join(benchmarksets)}')
