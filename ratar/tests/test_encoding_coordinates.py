...
def test_coordinates_eq(mol_file1, mol_file2):
    ...
    coordinates1.from_molecule(molecule_loader1.molecules[0])
    coordinates2.from_molecule(molecule_loader1.molecules[0])
    coordinates3.from_molecule(molecule_loader2.molecules[0])
...
@pytest.mark.parametrize(
    ...
    [
        (
            ...
            "x y z".split(),
            dict(zip("ca pca pc".split(), [8, 34, 29])),
            dict(
                zip(
                    "ca pca pc".split(),
                    [
