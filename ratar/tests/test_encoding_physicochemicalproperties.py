...
def test_physicochemicalproperties_eq(mol_file1, mol_file2):
    ...
    physicochemicalproperties1.from_molecule(molecule_loader1.molecules[0])
    physicochemicalproperties2.from_molecule(molecule_loader1.molecules[0])
    physicochemicalproperties3.from_molecule(molecule_loader2.molecules[0])
...
@pytest.mark.parametrize(
    ...
    [
        (
            ...
            dict(
                zip("ca/z1 ca/z123 pca/z1 pca/z123 pc/z1 pc/z123".split(), [8, 8, 34, 34, 29, 29])
            ),
            dict(
                zip(
                    "ca/z1 ca/z123 pca/z1 pca/z123 pc/z1 pc/z123".split(),
